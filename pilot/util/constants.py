...
VERSION = '10'   # version number is '1' for first release, '0' until then, increased for bigger updates
REVISION = '3'  # revision number should be reset to '0' for every new version release, increased for small updates
BUILD = '69'     # build number should be reset to '1' for every new development cycle
