...
"""Copytool capability definitions for the Rubin experiment plugin."""

from hashlib import md5


def mv_to_final_destination() -> bool:
    """Decide if mv is allowed to move files to/from final destination.

    Returns:
        bool: True if mv is allowed to move files to final destination, False otherwise.
    """
    return False
