...
def remove_redundant_files(workdir: str, outputfiles: Optional[list] = None, piloterrors: Optional[list] = None, debugmode: bool = False) -> None:
...
def get_utility_commands(order: Optional[int] = None, job: Optional[JobData] = None, base_urls: Optional[list] = None) -> Optional[dict]:
    ...
    Returns:
        Optional[dict]: Dictionary of utilities to be executed in parallel with the payload.
    """
...
def get_utility_command_setup(name: str, job: object, setup: Optional[str] = None) -> str:
...
def get_utility_command_output_filename(name: str, selector: Optional[bool] = None) -> str:
...
def get_metadata(workdir: str) -> Optional[str]:
    ...
    Returns:
        Optional[str]: Metadata string, or None if file does not exist.
    """
